...
**TL;DR**  
An end-to-end data science project analyzing rent prices and CPI inflation across Canada,
featuring EDA, feature importance modeling, and an interactive Streamlit dashboard.

📌 Project Overview

This project analyzes cost of living trends in Canada by combining rental data with Consumer Price Index (CPI) data from Statistics Canada.
...
How rent prices (1-bedroom and 2-bedroom) have changed across Canadian cities
...
Final output:
data/processed/Final_cost_of_living_data.csv
...
CPI components with smooth, consistent trends (e.g., Recreation, Alcohol & Tobacco) can appear highly predictive — not because they cause rent increases, but because they proxy overall inflation dynamics.

This analysis emphasizes correlation vs causation.
...
Connect GitHub repo on Streamlit Cloud
